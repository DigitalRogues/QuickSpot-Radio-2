...
- (void) applicationDidFinishLaunching:(NSNotification *)aNotification
{
    ...
    [hotKeyCenter registerHotKeyWithKeyCode:0x0D modifierFlags:(NSAlternateKeyMask | NSCommandKeyMask) target:self action:@selector(setGrowlPost:) object:nil];
    [hotKeyCenter registerHotKeyWithKeyCode:0x2D modifierFlags:(NSAlternateKeyMask | NSCommandKeyMask) target:self action:@selector(nextSong:) object:nil];
    [hotKeyCenter registerHotKeyWithKeyCode:0x23 modifierFlags:(NSAlternateKeyMask | NSCommandKeyMask) target:self action:@selector(playPause:) object:nil];
