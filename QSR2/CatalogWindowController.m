...
{
    self.ArtistArray = [[Artist MR_findAllInContext:[NSManagedObjectContext MR_contextForCurrentThread]] mutableCopy];
...
{
    //grab foirm CD
    NSArray *catalogArray = [Catalog MR_findAllInContext:[NSManagedObjectContext MR_contextForCurrentThread]];
